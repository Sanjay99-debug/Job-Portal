...
function Customer() {
  ...
  const apiUrl = "https://localhost:7246/api/Customers";
  ...
  const handleEdit = (obj) => {
    ...
    setLanguages(
      obj.languages
        ? obj.languages.split(",").map((lang) => ({ label: lang, value: lang }))
        : []
    );
    setImage(null);
  ...
  const handleDownload = () => {
    const csvContent =
      ...
      list
        .map(
          (c) =>
            `${c.id},${c.name},${c.address},${c.mobile},${c.email},${c.password},${c.gender},${c.qualification},${c.languages},${c.imagePath}`
        )
        .join("\n");
  ...
  return (
    <div className="container">
      <div className="d-flex justify-content-between mb-2 gap-2">
        <h4>
          <i className="bi bi-people-fill me-2 text-primary fs-2"></i> Customer
          Management
        </h4>
          ...
          {paginatedList.map((c) => (
            <tr key={c.id}>
              ...
              <td>
                {c.imagePath ? (
                  <img
                    src={`https://localhost:7246/Uploads/${c.imagePath}`}
                    alt="Customer"
                    width={50}
                    height={50}
                  />
                ...
                <div className="modal-body">
                  {selectedCustomer?.imagePath && (
                    <div className="mb-4 text-center">
                      <img
                        src={`https://localhost:7246/Uploads/${selectedCustomer.imagePath}`}
                        alt="Customer"
                    ...
                    <div className="row mb-3">
                      ...
                      <div className="col-md-6">
                        <p>
                          ...
                          {selectedCustomer?.qualification}
                        </p>
                      </div>
                    </div>
