...
function Userroles() {
    ...
    if (newuserId && newroleId) {
      ...
      try {
        const res = await axios.post(
          "https://localhost:7246/api/UserRoles",
          payload
        );
  ...
  const handleDeleteUserRole = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://localhost:7246/api/UserRoles/${id}`);
    ...
    if (editUserRole?.userId && editUserRole?.roleId) {
      ...
      try {
        const res = await axios.put(
          `https://localhost:7246/api/UserRoles/${editUserRole.id}`,
          payload
        );
  ...
  useEffect(() => {
    axios
      .get("https://localhost:7246/api/UserRoles")
      .then((res) => setUserRoles(res.data.data))
      .catch((err) => console.error("UserRoles error:", err));

    axios
      .get("https://localhost:7246/api/Users")
      .then((res) => setUsers(res.data.data || res.data))
      .catch((err) => console.error("Users error:", err));

    axios
      .get("https://localhost:7246/api/Roles")
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-muted">
        <i className="bi bi-person-lines-fill me-2 text-success"></i>Add User
        Roles
      </h2>
      <button
            ...
            <tr key={c.id}>
              ...
              <td>
                ...
                <button
                  ...
                  onClick={() => handleDeleteUserRole(c.id)}
                >
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                ...
                <button className="btn btn-primary" onClick={handleAddUserRole}>
                  Assign
                </button>
              </div>
            </div>
